...
window.addEventListener("scroll", function() {
    ...
    // If the page is scrolled down more than 10px
    if (scrollY > 10) {
      // Move the helmet image to the left
      document.getElementById("helmet-b").style.transform = "translateX(-50%)"; // Move it to the left
    }
  });
